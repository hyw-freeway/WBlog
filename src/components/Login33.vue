    ...
    <div class="switch__circle switch__circle--t"></div>
      ...
      >
        <form class="form" id="a-form" method="" action="">
          <h2 class="form_title title">周报系统-注册</h2>
      ...
      >
        ...
        <form class="form" id="b-form" method="" action="">
          <h2 class="form_title title">周报系统-登录</h2>
          <div class="form__icons">
            <img
              class="form__icon"
              src="data:image/svg+xml;base64,"
  ...
  methods: {
    submitForm() {
      if (this.loginForm.passWord == "" || this.loginForm.account == "") {
        ...
        login(this.loginForm.passWord, this.loginForm.account).then((res) => {
          console.log(res);
          if (res.data == "Bad credentials") {
            Message("账号或密码错误，请重试");
          } else {
            localStorage.setItem("token", res.data.details.sessionId);
            console.log(res.data.details.sessionId);
            if (res.data.details.sessionId) {
